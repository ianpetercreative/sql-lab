...
SELECT c.name, c.population, c.region FROM country c WHERE region='Southern Europe' ORDER BY population LIMIT 1; 
...
-- Write SQL query here
-- Checking cities in San Marino and Italy:
...
WHERE c.continent = 'South America' AND city.name LIKE 'Ser%';
...
-- Write SQL query here
SELECT city.name, c.name, c.code
FROM country c 
...
-- She's headed to Santa Monica, California 
